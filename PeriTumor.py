...
for i in range (0, 2):
    ...
    output_folder_border3 = os.path.join(sav_path, file_name) + "_border3.nii.gz"
    output_folder_border5 = os.path.join(sav_path, file_name) + "_border5.nii.gz"
    output_folder_border3e = os.path.join(sav_path, file_name) + "_border3e.nii.gz"
    output_folder_border5e = os.path.join(sav_path, file_name) + "_border5e.nii.gz"
    ...
    array2nii(mask_img_arr_border3, output_folder_border3, Niimage_resample)
    array2nii(mask_img_arr_border5, output_folder_border5, Niimage_resample)
    array2nii(mask_img_arr_border3e, output_folder_border3e, Niimage_resample)
    array2nii(mask_img_arr_border5e, output_folder_border5e, Niimage_resample)