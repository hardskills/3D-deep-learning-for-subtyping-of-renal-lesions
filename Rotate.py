...
# 路径定义
data_dir = r"D:\CTdata\MaskCrop\bg\C\Train"
subtype1 = ['ChRCC', 'OtherMG', 'pRCC']

## for ChRCC, OtherMG, and pRCC 旋转
for i in range(0, 3):
